    ...
    return (
        <div>
            <div className="container my-5">
                ...
                <button className='btn btn-outline-success mt-3' onClick={HandleUpChange}>Convert To Upper Care</button>&nbsp;&nbsp;&nbsp;
                <button className='btn btn-outline-info mt-3' onClick={HandleLowerChange}>Convert To Lower Care</button>&nbsp;&nbsp;&nbsp;
                <button className='btn btn-outline-danger mt-3' onClick={HandleCopy}>Copy</button>&nbsp;&nbsp;&nbsp;
                <button className='btn btn-outline-danger mt-3' onClick={HandleRemoveSpace}>Remove Extra Text</button>&nbsp;&nbsp;&nbsp;
